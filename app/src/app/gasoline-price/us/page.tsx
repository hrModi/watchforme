...
export default async function GasolinePriceUSPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Gas Prices by State', item: `${baseUrl}/gasoline-price/us` },
    ],
  }
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2 mb-5">
            <span className="px-3 py-1.5 rounded-lg text-sm font-medium" style={{ backgroundColor: 'var(--accent)', color: '#fff', border: '1px solid var(--accent)' }}>Gasoline</span>
