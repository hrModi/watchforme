    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto flex flex-wrap gap-2">
          <Link href="/gold-price/us" className="px-3 py-1.5 rounded-lg text-sm font-medium" style={{ backgroundColor: 'var(--surface-2)', color: 'var(--text-muted)', border: '1px solid var(--border)' }}>Gold</Link>
